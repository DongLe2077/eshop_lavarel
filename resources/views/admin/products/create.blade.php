...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                {{-- Upload ảnh --}}
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Ảnh sản phẩm</label>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Nếu đã upload file ở trên, URL này sẽ được bỏ qua.</p>
                </div>
